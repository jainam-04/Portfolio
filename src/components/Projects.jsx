  ...
  return (
    <div>
      <div className="bg-cyan-950 text-white py-5">
        ...
        <div className="flex justify-center items-center gap-28 project-container">
          <div className="py-10 mx-5 bg-gray-600 px-5 mt-5 rounded-xl project-card">
          ...
          <div className="py-10 mx-5 bg-gray-600 px-5 mt-5 rounded-xl project-card">
            <img
              src={newsapp}
              alt="clinicImage"
              className="rounded-lg h-[197px] w-[350px]"
            />
